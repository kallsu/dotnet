...
Execute unit tests
```
    cd "Aws.Serverless.GExample01.DoWorkLambda/test/Aws.Serverless.GExample01.DoWorkLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Aws.Serverless.GExample01.DoWorkLambda/src/Aws.Serverless.GExample01.DoWorkLambda"
